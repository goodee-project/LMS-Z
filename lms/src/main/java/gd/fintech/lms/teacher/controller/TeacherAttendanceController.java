...
public class TeacherAttendanceController {
	...
	//출석부 학생 목록 출력(일)
	@GetMapping("/teacher/attendanceList/{lectureNo}/{target}/{currentYear}/{currentMonth}/{currentDay}")
	...
	public String modifyAttendanceStateOne(Attendance attendance, @PathVariable(value = "studentId") String studentId, 
		...
		return "redirect:/teacher/attendanceList/" + attendance.getLectureNo() + "/target" + "/" + currentYear + "/" + currentMonth + "/" + currentDay;
	}

...
public class TeacherCommentController {
	...
	//댓글삭제
	@GetMapping("/teacher/removeQuestionComment/{questionNo}/{questionCommentNo}/{currentPage}")
	...
	public String modifyQuestionComment(QuestionComment questionComment, @PathVariable(value = "questionNo") int questionNo, 
																		 @PathVariable(value = "currentPage") int currentPage) {

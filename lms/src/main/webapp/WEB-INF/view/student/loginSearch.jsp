...
<!-- 로고 밑 메뉴 -->
	               ...
	               <div class="row">
	                    ...
	                    <div class="col-md-5 col-lg-4">
	                        <div class="card" id="cardStyle" style="height:370px;">
	                        	<form id="searchForm" method="post" action="${path}/studentLoginSearch">
		                            <div class="card-body">
		                            ...
		                            <div id="loginSubTitle" class="text-center">
		                                ...
		                                <table id="loginTable">
		                                	<tr>
		                                		<td>
		                                			<input type="text" class="form-control-plaintext form-control-lg border-black" style="padding: 10px; margin-top:-5px;" id="studentName" name="studentName" placeholder="이름을 입력해 주세요">
		                                		</td>
		                                	</tr>
		                                	<tr>
		                                		<td>
		                                			<input type="text" class="form-control-plaintext form-control-lg border-black" style="padding: 10px;" id="studentEmail" name="studentEmail" placeholder="이메일을 입력해 주세요">
		                                		</td>
		                                	</tr>
		                                </table>
    ...
    <script>
		$('#btnSearch').click(function(){
			$.ajax({
				url:'${path}/studentSearchToNameAndEmail',
				type:'GET',
				data:{studentName: $('#studentName').val(), studentEmail: $('#studentEmail').val()},

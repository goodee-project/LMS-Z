            				...
            				<div class="card-body">
            					...
            					<table id="lmsTable" class="table table" style="margin-top:20px;">
            						<tr>
            							...
            							<td>${noticeOne.lectureNoticeCount}</td>
            						</tr>
            						<tr>
            							<td>게시일</td>
								...
								<a class="btn btn-outline-secondary" style="border-radius: 4px;"  href="${path}/student/lectureNoticeList/${lectureNo}/${currentPage}">목록</a>
							</div>
						</div>
					</div>
				</div>

	...
	<div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
		...
		<div class="page-wrapper">
			...
			<div class="container-fluid">
				&emsp;<span><a type="button" class="btn btn-outline-secondary mb-2" href="${path}/student/reportList/${studentId}/1">전체</a></span>
				<c:if test="${!empty lectureList}">
					<c:forEach var="l" items="${lectureList}">
						&emsp;<span><a type="button" class="btn btn-outline-secondary mb-2" href="${path}/student/reportLectureList/${studentId}/${l.lectureNo}/1">${l.lectureName}</a></span>
					</c:forEach>
				</c:if>
				<div class="row">
							...
							<div class="card-body">
								<div class="table-responsive">
									<div class="d-flex align-items-center">
										<div><a type="button" class="btn btn-outline-secondary sidebar-link" href="${path}/student/reportOverdueList/${studentId}/1">마감된 과제</a></div>
									</div>	
											...
											<div>
												...
												<c:forEach var="l" begin="${lectureUnderFirstPage}" end="${lectureUnderLastPage}">
													<c:if test="${l<=lastLecturePage && lectureCurrentPage == l}">
														<a id="pagingStyle" class="bg-secondary font-18" href="${path}/student/reportLectureList/${studentId}/${lectureNo}/${l}">${l}</a>
													</c:if>
													<c:if test="${l<=lastLecturePage && lectureCurrentPage != l}">
														<a class="font-18" href="${path}/student/reportLectureList/${studentId}/${lectureNo}/${l}">${l}</a>
													</c:if>
												</c:forEach>

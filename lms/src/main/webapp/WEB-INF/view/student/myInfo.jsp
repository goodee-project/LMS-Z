                    ...
                    <div class="col-md-9 col-lg-9">
	                    <div class="row">
		                    <div class="col-md-6 col-lg-6"> 
		                        <div class="card" id="cardStyle" style="height:270px">
		                            <div class="card-body">
		                            	<div class="d-flex align-items-center">
				                            <div class="col-md-6 col-lg-12">
				                            	...
				                            	<div class="card-text">
					                            	<table class="table table" id="myInfoTable">
					                            		<tr>
					                            			<th rowspan="2"><img src="${path}/images/${studentOne.studentImage}" style="width:150px;height:170px"></th>
	                  	  ...
	                  	  <div class="col-md-6 col-lg-8"> 
		                        <div class="card" id="cardStyle" style="height:200px">
		                            <div class="card-body">
		                            	<div class="d-flex align-items-center">
				                            <div class="col-md-6 col-lg-12">
				                            ...
				                            <div class="col-md-6 col-lg-12">
				                            	...
				                            	<div class="card-text">
					                            	<table class="table table" id="myInfoTable">
					                            		...
					                            		<tr>
					                            			<td colspan="2">${studentOne.studentUpdatedate}</td>
					                            		</tr>
					                            	</table>
				                            	</div>
				                            </div>

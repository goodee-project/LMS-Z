                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                                ...
                                <!-- 마이페이지 사진 -->
                                <img src="${path}/images/${studentImage}" alt="user" class="rounded-circle"
                                    width="40">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <a class="dropdown-item" href="${path}/student/myInfo/${studentId}"><i data-feather="mail"
                                        class="svg-icon mr-2 ml-1"></i>
                                    My Page</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="${path}/student/logout"><i data-feather="power"
                                        class="svg-icon mr-2 ml-1"></i>
                                    Logout</a>
                            </div>
                        </li>

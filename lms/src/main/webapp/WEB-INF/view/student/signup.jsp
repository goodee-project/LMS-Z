	                                    ...
	                                    <table class="table no-wrap v-middle mb-0">
	                                    	...
	                                    	<tr class="border-0">
	                                   		...
	                                   		<tr class="border-0">
	                                    		...
	                                    		<td class="font-weight-medium text-dark border-top-0"><input type="text" name="studentName"></td>
	                                    		<td class="border-0"></td>    
	                                   		</tr>
	                                   		
	                                   		<tr class="border-0">
	                                    		<th class="border-0 font-14 font-weight-medium">이메일</th>
	                                    		<td class="font-weight-medium text-dark border-top-0"><input type="text" name="studentEmail"></td>
	                                   		...
	                                   		<tr class="border-0">
	                                    		...
	                                    		<td class="font-weight-medium text-dark border-top-0">
	                                    			<input type="radio" name="studentGender" value="남">남
	                                    			<input type="radio" name="studentGender" value="여">여
	                                    		</td>
	                                    		<td class="border-0"></td>    
	                                   		</tr>
	                                   		...
	                                   		<tr class="border-0">
	                                    		...
	                                    		<td class="font-weight-medium text-dark border-top-0"><input type="text" name="studentAddressMain"></td>
	                                   		...
	                                   		<tr class="border-0">
	                                    		...
	                                    		<td class="font-weight-medium text-dark border-top-0"><input type="text" name="studentAddressSub"></td>
	                                    		<td class="border-0"></td>    
	                                   		</tr>
	                                   		
	                                   		<tr class="border-0">
	                                    		<th class="border-0 font-14 font-weight-medium">생일</th>
	                                    		<td class="font-weight-medium text-dark border-top-0"><input type="date" name="studentBirth"></td>
	                                    		<td class="border-0"></td>    
	                                   		</tr>
	                                    </table>

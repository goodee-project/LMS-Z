            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Lecture Notice</h3>
                    </div>
                </div>
            </div>
            <!-- 내용 -->
										...
										<c:if test="${!empty noticeList}">
											<c:forEach var="n" items="${noticeList}">
												<tr>
													...
													<td><a class="btn btn-outline-light text-secondary btn-block" href="${path}/teacher/modifyLectureNoticeCount/${lectureNo}/${n.lectureNoticeNo}">${n.lectureNoticeTitle}</a></td>
            					...
            					<br>
							   	<div id="paging" style="text-align: center; padding: 7px;">
							     	...
							     	<c:forEach var="i" begin="${startPage }" end="${lastPage}">
							     		...
							     		<c:if test="${currentPage != i }">
								      		<span>
								      			<a class="font-18" href="${path}/teacher/lectureNoticeList/${lectureNo}/${i}">${i}</a>
								      		</span>
							     		</c:if>
							     	</c:forEach>
							    	</c:if>

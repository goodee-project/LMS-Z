            				...
            				<div class="card-body">
            					...
            					<div class="row">
			           				<div class="col-lg-6 col-md-6">
				           				<div class="card">
											<a style="padding:50px; font-size:24px;" class="btn btn-outline-info font-weight-bold" href="${path}/teacher/studentListByTest/${lectureNo}">학생 답안지 조회</a>
										</div>
									</div>
									<div class="col-lg-6 col-md-6">
				           				<div class="card">
											<a style="padding:50px; font-size:24px;" class="btn btn-outline-info font-weight-bold" href="${path}/teacher/testQuestionList/${lectureNo}">시험문제 목록</a>
										</div>
			            			</div>
		            			</div>

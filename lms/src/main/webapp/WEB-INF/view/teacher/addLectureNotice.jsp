            	...
            	<div class="row">
            		<div class="col-lg-12 col-md-12">
            			<div class="card" id="cardStyle">
            				<div class="card-body">
            					<h4 class="card-title">강의 공지사항 등록</h4>
            					
            					<form action="${path}/teacher/addLectureNotice/${lectureNo}" method="post">
            						<table id="lmsTable" class="table" style="margin-top:20px; text-align:center;">
            							<tr>
            								<td style="width:10%;">강좌번호</td>
            								<td><input class="form-control" type="text" name="lectureNo" value="${lectureNo}" readonly="readonly"></td>
            							</tr>
            							<tr>
            								<td>제목</td>
            								<td><input class="form-control" type="text" name="lectureNoticeTitle" id="lectureNoticeTitle"></td>
            							</tr>
            							<tr>
            								<td>내용</td>

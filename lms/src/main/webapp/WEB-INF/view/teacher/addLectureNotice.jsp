...
<body>
	...
	<form method="post" action="${path}/teacher/addLectureNotice/${lectureNo}">
		...
		<div>
			제목
			<input type="text" name="lectureNoticeTitle" id="lectureNoticeTitle" style="width:500px">
		</div>
		<div>
			내용
			<textarea rows="3" cols="50" name="lectureNoticeContent" id="lectureNoticeContent"></textarea>
		</div>

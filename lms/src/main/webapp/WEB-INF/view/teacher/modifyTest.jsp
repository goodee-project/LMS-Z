            		...
            		<div class="col-lg-12 col-md-12">
            			<div class="card" id="cardStyle">
            				<div class="card-body">
            					...
            					<form class="form-group" id="modifyTest" action="${path}/teacher/modifyTest/${lectureNo}" method="post">
            						<input type="hidden" name="lectureNo" value="${lectureNo}">
            						<table id="lmsTable" class="table" style="margin-top:20px; text-align:center;">
            							<tr>
											<td>시험내용</td>
											<td>
												<input class="form-control" type="text" name="testContent" value="${test.testContent}" id="testContent">
										...
										<tr>
											<td>시험시작시간</td>
											<td>
												<input class="form-control" type="datetime-local" name="testStartdate" id="testStartdate" value="${test.testStartdate}">
										...
										<tr>
											<td>시험종료시간</td>
											<td>
												<input class="form-control" type="datetime-local" name="testEnddate" id="testEnddate" value="${test.testEnddate}">
												<div id="checkEnd"></div>
											</td>
										</tr>
            						</table>

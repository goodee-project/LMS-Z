            			...
            			<div class="card" id="cardStyle">
            				<div class="card-body">
								...
								<div style="float:right;">
									<a class="btn btn-info" style="border-radius:4px;" href="${path}/teacher/lectureArchiveModify/${teacherId}/${lectureArchive.lectureNo}/${lectureArchive.lectureArchiveNo}">수정</a>
									<a class="btn btn-outline-danger" style="border-radius:4px;" href="${path}/teacher/lectureArchiveRemove/${lectureArchive.lectureArchiveNo}/${teacherId}/${lectureArchive.lectureNo}" onclick="return confirm('삭제하시겠습니까?');">삭제</a>
								</div>
							</div>
						</div>
					</div>

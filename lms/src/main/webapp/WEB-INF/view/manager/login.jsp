	               ...
	               <div class="row">
	                    ...
	                    <div class="col-md-5 col-lg-4">
	                        <div class="card" id="cardStyle" style="height:370px;">
	                        	<form id="loginForm" method="post" action="${path}/managerLogin">
		                            <div class="card-body">
		                            ...
		                            <div id="loginSubTitle" class="text-center">
		                                ...
		                                <table id="loginTable">
		                                	<tr>
		                                		<td>
		                                			<input type="text" class="form-control-plaintext form-control-lg border-black" style="padding: 10px; margin-top:-5px;" id="accountId" name="accountId" value="manager1">
		                                		</td>
		                                	</tr>
		                                	<tr>
		                                		<td>
		                                ...
		                                <button id="btnResult" class="btn btn-success font-3 btn-block btn-lg border-rad" type="button">로그인</button>
		                            </div>
	                            </form>
	                            <div id="loginStyle">
			                        <a href="${path}/managerSignup">회원가입</a>&nbsp;&nbsp;|&nbsp; 
			                        <a href="${path}/managerLoginSearch">아이디/패스워드 찾기</a>
		                        </div>
	                        </div>
	                    </div>
	                </div>

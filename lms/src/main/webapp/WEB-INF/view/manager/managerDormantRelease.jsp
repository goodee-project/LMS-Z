                          		...
                          		<div class="row">
                          			<div class="col-lg-3 col-md-3"></div>
			           				<div class="col-lg-9 col-md-9">
			           					...
			           					<input type="text" id="managerId" value="${managerId }" hidden="hidden">
    ...
    <script>
		$(document).ready(function(){
			...
			$('#requestBtn').click(function(){
				...
				$.ajax({
					url:'${path}/managerDormantMsg/'+managerId,
					type:'GET',
			...
			$('#confirmBtn').click(function(){
				if($('#numCk').val() != $('#numMsg').val()){
						...
						alert("인증에 성공하였습니다.");
						$('#confirmBtn').attr("href","${path}/managerDormantReleaseSuccess/${managerId}");
					}
				})
			})
